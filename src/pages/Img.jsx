    ...
    <div>
      <div className="fixed bottom-10 left-1/2 -translate-x-1/2 w-[700px]">
        <div className="flex gap-1">
          <input type="text" className='border p-3 py-3 w-full rounded-l-xl focus:outline-none focus:border-neutral-500' placeholder='Ask to genrate Image from chatGPT' />
